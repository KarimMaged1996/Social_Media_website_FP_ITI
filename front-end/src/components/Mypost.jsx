...
>>>>>>> 6c19af8b778d8bb79c6ca75737fa5604c383ef82
...
=======
        ...
        const upvote = () => {
            ...
            if (vote.value == 1)
            {
                ...
                // decrease the score 
                axios
                .patch(`http://127.0.0.1:8000/post/update/${post.id}`, {"score": score-1},{
                    headers: {
                ...
                axios
                .patch(`http://127.0.0.1:8000/api/update/${post.author.id}`, {"techbin": techbin-1},{
                    headers: {
                        // 'Authorization': `Bearer ${token}`,
                        'Content-Type': 'multipart/form-data'
                    }
                ...
                // decrease the score 
                axios
                .patch(`http://127.0.0.1:8000/post/update/${post.id}`, {"score": score+2},{
                    headers: {
                        // 'Authorization': `Bearer ${token}`,
                        'Content-Type': 'multipart/form-data'
                    }
                ...
                // decrease the techbin of the user
                axios
                .patch(`http://127.0.0.1:8000/api/update/${post.author.id}`, {"techbin": techbin+2},{
                    headers: {
                        // 'Authorization': `Bearer ${token}`,
                        'Content-Type': 'multipart/form-data'
                    }
            ...
            axios
            .post(LikepostURL,{"user": user_id,"post": post.id, "value": 1,},
            {
                headers: 
                {
                    'Content-Type': 'application/json',
        ...
        <div class="roomListRoom">
                <div class="roomListRoom__header">
                    ...
                    <div className="room__topRight">
                        ...
                        {/* edit button in the top right */}
                        {user_id==post.author.id?<a href={`/post/edit/${post.id}`} >
                            <svg
                            enable-background="new 0 0 24 24"
                            height="20"
                            viewBox="0 0 24 24"
                        ...
                        {/* delete buttun in the top right */}
                        {user_id==post.author.id? <a onClick={deletepost}>
                ...
                <div class="roomListRoom__content">
                    <div onClick={()=>{navigate(`/post/${post.id}`)}}><a >{post.title}</a></div>
                    <p>
                        {post.content}
                    </p>
                </div>
